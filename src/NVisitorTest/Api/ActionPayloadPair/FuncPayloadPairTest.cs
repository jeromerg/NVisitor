...
namespace NVisitorTest.Api.ActionPayloadPair
{
    ...
    public class ActionPayloadPairTest
    {
        ...
        public class MyDir : ActionPayloadPairDirector<ICar, IPerson, MyDir, int>
        {
            public MyDir(params IActionPayloadPairVisitorClass<ICar, IPerson, MyDir, int>[] visitorArray)
                : base(visitorArray)
            {
            }
        }

        public interface IVis<TCar, TPer> : IActionPayloadPairVisitor<ICar, IPerson, MyDir, TCar, TPer, int> 
            where TCar : ICar 
            where TPer : IPerson
        { }
        ...
        public void TestSimpleDoubleDispatch()
        {
            ...
            mockVisitor_Audi_Mechanic.Verify(v => v.Visit(dir, It.IsAny<Audi>(), It.IsAny<Mechanic>(), It.IsAny<int>()), Times.Never);

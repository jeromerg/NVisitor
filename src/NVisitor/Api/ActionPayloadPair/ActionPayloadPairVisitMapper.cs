...
namespace NVisitor.Api.ActionPayloadPair
{
    ...
    {
        public ActionPayloadPairVisitMapper(IEnumerable<IActionPayloadPairVisitorClass<TFamily1, TFamily2, TDir, TPayload>> visitors)
                ...
                Action<IActionPayloadPairDirector<TFamily1, TFamily2, TDir, TPayload>, TFamily1, TFamily2, TPayload> directorDelegate)
        {
            ...
            Type visitorClosedType = typeof(IActionPayloadPairVisitor</*TF1*/,/*TF2*/,/*TDir*/,/*TNod1*/,/*TNod2*/,/*TPay*/>)

...
namespace NVisitor.Api.FuncPayloadPair
{
    ...
    public class FuncPayloadPairVisitMapper<TFamily1, TFamily2, TDir, TPayload, TResult>
        : PairVisitMapperBase<TFamily1, 
                              TFamily2, 
                              IFuncPayloadPairVisitorClass<TFamily1, 
                                                      TFamily2, 
                                                      TDir, 
                                                      TPayload, 
                                                      TResult>, 
                              Func<IFuncPayloadPairDirector<TFamily1, 
                                                       TFamily2, 
                                                       TDir, 
                                                       TPayload,
                                                       TResult>, TFamily1, TFamily2, TPayload, TResult>>
    ...
    {
        public FuncPayloadPairVisitMapper(IEnumerable<IFuncPayloadPairVisitorClass<TFamily1, TFamily2, TDir, TPayload, TResult>> visitors)
            : base(visitors, typeof (IFuncPayloadPairVisitor<,,,,,,>), 3, 4)
        {
        }

        protected override Func<IFuncPayloadPairDirector<TFamily1, TFamily2, TDir, TPayload, TResult>, TFamily1, TFamily2, TPayload, TResult> 
            CreateVisitDelegate(
                ...
                Func<IFuncPayloadPairDirector<TFamily1, TFamily2, TDir, TPayload, TResult>, TFamily1, TFamily2, TPayload, TResult> directorDelegate)
        {
            // create the closed generic type of the visitor
            Type visitorClosedType = typeof(IFuncPayloadPairVisitor</*TF1*/,/*TF2*/,/*TDir*/,/*TNod1*/,/*TNod2*/,/*TPay*/,/*TRes*/>)

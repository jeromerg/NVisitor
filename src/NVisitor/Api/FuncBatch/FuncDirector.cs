...
namespace NVisitor.Api.FuncBatch
{
    ...
    public abstract class FuncDirector<TFamily, TDir, TPayload, TResult> : IFuncDirector<TFamily, TDir, TPayload, TResult>
        where TDir : IFuncDirector<TFamily, TDir, TPayload, TResult>
    {
        private readonly IFuncVisitMapper<TFamily, TDir, TPayload, TResult> mVisitMapper;
        ...
        protected FuncDirector(IEnumerable<IFuncVisitorClass<TFamily, TDir, TPayload, TResult>> visitorEnumerable)
        {
            mVisitMapper = new FuncVisitMapper<TFamily, TDir, TPayload, TResult>(visitorEnumerable);
        }
        ...
        protected FuncDirector(IFuncVisitMapper<TFamily, TDir, TPayload, TResult> visitMapper)
        {
        ...
        public TResult Visit(TFamily node, TPayload payload)
        {
            ...
            Func<IFuncDirector<TFamily, TDir, TPayload, TResult>, TFamily, TPayload, TResult> visitAction;
            try
            {

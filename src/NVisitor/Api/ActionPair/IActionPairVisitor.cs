...
namespace NVisitor.Api.ActionPair
{
    ...
    public interface IActionPairVisitor<TFamily1, TFamily2, TDir, TNode1, TNode2>
        : IActionPairVisitorClass<TFamily1, TFamily2, TDir>
        ...
        where TDir : IActionPairDirector<TFamily1, TFamily2, TDir>
    {
        ...
        void Visit([NotNull] TDir director, [NotNull] TNode1 node1, [NotNull] TNode2 node2);
    }
}
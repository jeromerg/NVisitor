...
namespace NVisitor.Api.ActionPair
{
    ...
    public class ActionPairVisitMapper<TFamily1, TFamily2, TDir>
        : PairVisitMapperBase
              <TFamily1, TFamily2, IActionPairVisitorClass<TFamily1, TFamily2, TDir>,
              Action<IActionPairDirector<TFamily1, TFamily2, TDir>, TFamily1, TFamily2>>,
        ...
        where TDir : IActionPairDirector<TFamily1, TFamily2, TDir>
    {
        ...
        protected override Action<IActionPairDirector<TFamily1, TFamily2, TDir>, TFamily1, TFamily2> CreateVisitDelegate(
            TFamily1 node1,
            TFamily2 node2,
            Type visitorNode1Type,
            Type visitorNode2Type,
            IActionPairVisitorClass<TFamily1, TFamily2, TDir> visitorInstance,
            Action<IActionPairDirector<TFamily1, TFamily2, TDir>, TFamily1, TFamily2> directorDelegate)
        {
            // create the closed generic type of the visitor
            Type visitorClosedType = typeof (IActionPairVisitor<,,,,>).MakeGenericType(typeof (TFamily1),
                                                                                       typeof (TFamily2),
                                                                                       typeof (TDir),
                                                                                       visitorNode1Type,
                                                                                       visitorNode2Type);
            ...
            return
                (someDirector, someNode1, someNode2) =>
                InvokeUtil.InvokeWithUnwrapper(visitMethod, visitorInstance, new object[] { someDirector, someNode1, someNode2 });
        }
    }
}